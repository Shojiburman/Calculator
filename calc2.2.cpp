...
int main()
{
    ...
    cout<<"||# For SUMMATION -- press (a+b)     |";cout<<"# For sin(a) -- press (asin)|";cout<<"# For sin inverse (a) -- press (a asin)||"<<endl;
    cout<<"||# For SUBSTRACTION -- press (a-b)  |";cout<<"# For cos(a) -- press (acos)|";cout<<"# For cos inverse (a) -- press (a acos)||"<<endl;
    cout<<"||# For MULTIPLICATION -- press (a*b)|";cout<<"# For tan(a) -- press (atan)|";cout<<"# For tan inverse (a) -- press (a atan)||"<<endl;
    cout<<"||# For DIVITION -- press (a/b)      |";cout<<"                            |";cout<<"                                       ||"<<endl;
    cout<<"||# For square -- press (a^b)        |";cout<<"                            |";cout<<"                                       ||"<<endl;
